...
<div class="bg-white shadow-lg rounded-xl overflow-hidden">
    ...
    <div class="px-4 py-5 sm:px-6 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
        <div class="flex flex-col gap-4">
            ...
            <form action="<?= base_url('user/laporan') ?>" method="get" class="w-full">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div class="flex gap-2 sm:col-span-2 lg:col-span-1">
                        ...
                        <a href="<?= base_url('user/laporan') ?>" class="flex-1 text-center bg-gray-200 text-gray-700 font-semibold py-2 px-4 rounded-lg hover:bg-gray-300 text-sm">Reset</a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if (empty($laporan)) : ?>
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-gray-500">Tidak ada laporan yang ditemukan untuk bidang <?= esc($user_bidang) ?>.</td>
                    </tr>
                <?php else : ?>
                    ...
                    <?php foreach ($laporan as $item) : ?>
                        <div class="border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
                            ...
                            <div class="space-y-1 text-sm text-gray-600 mb-4">
                                ...
                                <p class="break-words"><span class="font-medium">Lokasi:</span> <?= esc($item['lok_kejadian']); ?></p>
                                <p><span class="font-medium">Unit Kerja:</span> <?= esc($item['unit_kerja']); ?></p>
                            </div>

                            <div class="flex gap-2">
                                <a href="<?= base_url('user/laporan/show/' . $item['id']); ?>" class="flex-1 flex items-center justify-center px-3 py-2 text-blue-600 border border-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition-colors duration-200 text-sm">
                                    <i class="fas fa-eye mr-1"></i> Lihat
                                </a>
                                <form action="<?= base_url('user/laporan/delete/' . $item['id']); ?>" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus laporan ini?');" class="flex-1">
                                    <?= csrf_field(); ?>
