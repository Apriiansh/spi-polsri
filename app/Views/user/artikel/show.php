    ...
    <div class="bg-white shadow-xl rounded-2xl px-8 py-10">
        ...
        <div class="mb-6 text-sm text-gray-500 flex flex-wrap items-center gap-3">
            ...
            <div>
                ...
                Dibuat pada <?= esc(date('d M Y', strtotime($article['created_at']))) ?>
            </div>
        </div>
        ...
        <!-- Tombol Kembali -->
        <div class="mt-8">
            <a href="<?= base_url('user/artikel') ?>" class="inline-flex items-center px-5 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-xl shadow transition">
