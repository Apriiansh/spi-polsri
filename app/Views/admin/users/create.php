        ...
        <form action="<?= base_url('admin/users/store'); ?>" method="post" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" class="w-full px-3 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
